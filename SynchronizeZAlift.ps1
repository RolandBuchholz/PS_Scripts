...
try {
     ...
     $ListZALiftKeys.Add("Netzpfad", ([ZALiftKey]$key = New-Object ZALiftKey("All", "Netzpfad", $var_AuftragsNummer, "String")))
     ...
     $ListZALiftKeys.Add("Treibscheibe-RIA", ([ZALiftKey]$key = New-Object ZALiftKey("ZAL", "Treibscheibe-RIA", $var_NumberOfRopes, "String")))
     $ListZALiftKeys.Add("Treibscheibe-RIA_", ([ZALiftKey]$key = New-Object ZALiftKey("ZAL", "Treibscheibe-RIA_", $var_NumberOfRopes, "String")))
